    ...
    render() {
      return (
        <View style={[{
            ...
            <View style={{flex:2.5, flexDirection: 'row', justifyContent: 'flex-start'}}>
              {this.props.search == false && 
              <TouchableOpacity
                style={{ marginLeft: '8%', width: 28 }}
                onPress={() => {
              ...
              <View style={{marginLeft: '4%', padding: Platform.OS == 'ios' ? 2 : 0, marginBottom: Platform.OS == 'ios' ? null : 4, flex: 1, width: '100%' }}>
